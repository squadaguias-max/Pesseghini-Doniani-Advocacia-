  ...
  return (
    <section className="privacy-page">
      <article className="container privacy-content">
        ...
        <p>Após o envio, o site direciona você ao WhatsApp. A partir desse momento, o uso do serviço também fica sujeito aos termos e à política de privacidade do WhatsApp.</p>
